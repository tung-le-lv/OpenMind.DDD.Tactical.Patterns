...
///
/// Customer info pre-conditions (missing customer, missing email/address) throw
/// rather than failing the payment — they indicate a data integrity problem,
/// not a legitimate payment outcome.
/// </summary>
